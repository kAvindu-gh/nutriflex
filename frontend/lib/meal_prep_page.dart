...
class _MealPrepPageState extends State<MealPrepPage> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text("$current $unit / $max $unit", style: const TextStyle(fontSize: 14, color: Colors.white)),
              Text("${(percent * 100).round()}%", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: progressColor)),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Column(
          ...
          children: [
            ...
            Text("Create your perfect Sri Lankan Meal plate", style: TextStyle(fontSize: 12, color: Colors.grey)),
          ],
        ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            /// ROW 1
            Row(children: [
              Expanded(child: MealCard(title: "Steamed Rice", imagePath: "lib/assets/rice.jpg", items: const [
              ...
              Expanded(child: MealCard(title: "Mallum (Greens)", imagePath: "lib/assets/mallum.jpg", items: const [
            ...
            /// ROW 2
            Row(children: [
              Expanded(child: MealCard(title: "Vegetable Curry 1", imagePath: "lib/assets/veg1.jpg", items: const [
              ...
              const SizedBox(width: 10),
              Expanded(child: MealCard(title: "Vegetable Curry 2", imagePath: "lib/assets/veg2.jpg", items: const [
            ...
            /// ROW 3
            Row(children: [
              Expanded(child: MealCard(title: "Meat", imagePath: "lib/assets/meat.jpg", items: const [
              ...
              const SizedBox(width: 10),
              Expanded(child: MealCard(title: "Fresh Salad", imagePath: "lib/assets/salad.jpg", items: const [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: const Color(0xFF0A3D1F), borderRadius: BorderRadius.circular(20)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Your custom plate", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text("Save my recipe", style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold)),
                onPressed: () {},
              ),
            ),
          ],
      ...
      bottomNavigationBar: AppBottomNav(currentIndex: 1, onTap: (index) => print('Tab tapped: $index')),
    );
  }
}
...
class FoodItem {
  ...
  final int carbs;
  final int fat;
  const FoodItem({required this.name, required this.calories, required this.protein, required this.carbs, required this.fat});
}
...
class MealCard extends StatefulWidget {
  ...
  const MealCard({super.key, required this.title, required this.items, required this.onChanged, required this.imagePath});
          ...
          Stack(
            children: [
              ClipRRect(
                ...
                child: Image.asset(widget.imagePath, height: 110, width: double.infinity, fit: BoxFit.cover),
              ),
              Positioned(
                top: 12,
                right: 12,
          ...
          Padding(
            ...
            child: Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [Expanded(child: Text(widget.title)), const SizedBox()],
                ),
                DropdownButton<FoodItem>(
                  value: selectedItem,
                  hint: const Text("Select option"),
                  isExpanded: true,
                  items: widget.items.map((item) => DropdownMenuItem(value: item, child: Text(item.name))).toList(),
                  onChanged: (value) {
                    setState(() {
                      selectedItem = value;
                      count = 0;
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("$count"),
                    IconButton(icon: const Icon(Icons.add_circle, color: Colors.greenAccent), onPressed: increase),
                  ],
                ),
              ],
            ),
