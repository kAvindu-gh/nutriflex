        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFF0A1F12).withValues(alpha: 0.08),
              borderRadius: BorderRadius.circular(32),
              border: Border.all(
            ...
            child: Stack(
              ...
              children: [
                ...
                // This uses _slideAnim, which removes the yellow line on line 102!
  AnimatedBuilder(
    animation: _slideAnim,
    builder: (context, _) {
      // Calculates how wide each tab is
      final double tabWidth = (MediaQuery.of(context).size.width - 32) / _tabs.length;
      return Positioned(
        left: _slideAnim.value * tabWidth,
        bottom: 0,
        width: tabWidth,
        height: 75, // Matches the container height
        child: Center(
          child: Container(
            width: 45,
            height: 4,
