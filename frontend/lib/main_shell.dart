...
class _MainShellState extends State<MainShell> {
  ...
  // IndexedStack keeps every screen alive — BMI inputs, scroll positions,
  // trending recipes etc. are all preserved when switching tabs
  final List<Widget> _screens = [
    const HomePage(),
    const _PlaceholderScreen(name: 'Meal Prep', icon: Icons.restaurant_menu),
    const _PlaceholderScreen(name: 'BMI',      icon: Icons.calculate_outlined),
    const _PlaceholderScreen(name: 'Alerts',   icon: Icons.notifications_none),
  ];
